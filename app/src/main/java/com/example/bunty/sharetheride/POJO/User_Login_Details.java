package com.example.bunty.sharetheride.POJO;
...
public class User_Login_Details implements Parcelable {
    ...
    public static final Parcelable.Creator<User_Login_Details> CREATOR = new Parcelable.Creator<User_Login_Details>() {
